...
### 2. In Your Browser:
Visit the interactive [Markdy Web Studio](https://markdy.com/playground/) to experiment with 29+ pre-built architecture templates (Kafka, Kubernetes, OAuth PKCE, Medallion Lakehouse, Microservices).
