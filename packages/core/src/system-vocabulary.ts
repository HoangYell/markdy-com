export const TECHNICAL_NODE_TYPES = [
  ...
  "db", "database", "sql", "nosql", "table", "index", "warehouse", "lake", "object_store", "storage", "bucket", "blob", "volume", "disk", "search", "cache",
  ...
  "auth", "identity", "oauth", "oidc", "jwt", "session", "policy", "role", "permission", "vault", "secret", "key", "certificate", "security",
  ...
  "start", "end", "state", "decision", "condition", "step", "loop", "sequence", "participant", "hub", "station", "bronze", "silver", "gold", "lane",
...
export const TECHNICAL_NODE_KINDS: Record<(typeof TECHNICAL_NODE_TYPES)[number], string> = {
  ...
  db: "data", database: "data", sql: "data", nosql: "data", table: "data", index: "data", warehouse: "data", lake: "data", object_store: "data", storage: "data", bucket: "data", blob: "data", volume: "data", disk: "data", search: "data", cache: "data",
  ...
  auth: "security", identity: "security", oauth: "security", oidc: "security", jwt: "security", session: "security", policy: "security", role: "security", permission: "security", vault: "security", secret: "security", key: "security", certificate: "security", security: "security",
  ...
  start: "flow", end: "flow", state: "flow", decision: "flow", condition: "flow", step: "flow", loop: "flow", sequence: "flow", participant: "flow", hub: "data", station: "compute", bronze: "data", silver: "data", gold: "data", lane: "flow",
