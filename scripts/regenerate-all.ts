...
const FEATURES = [
  ...
  },
  {
    ...
    example: 'scene "Login" theme=editorial type=sequence',
  },
  {
    id: "visuals",
...
- Optional modes: \`architecture\`, \`flowchart\`, \`tree\`, \`state\`, and \`sequence\`.
- Use \`theme=editorial\` for flat documentation scenes; other themes are \`paper\`, \`midnight\`, \`blueprint\`, and \`graphite\`.
