...
const githubUrl = "https://github.com/HoangYell/markdy-com/blob/main/AGENT.md";
...
async function findRepoRoot() {
  ...
  for (const candidate of candidates) {
    if (await fileExists(join(candidate, "AGENT.md"))) {
      return candidate;
    }
  }
...
- [Full LLM Context Bundle](${reference.fullContextUrl}): Complete text bundle generated from AGENT.md for tools that prefer one fetch.
...
- [GitHub Source](${reference.githubUrl}): Repository copy of the maintained AGENT.md source.
...
The content below is generated directly from AGENT.md during the website build.
